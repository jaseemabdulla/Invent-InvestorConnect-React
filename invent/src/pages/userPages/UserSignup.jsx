...
import { investorSignupAxios } from "../../api/investorApi";
...
function UserSignup() {
  ...
  async function onSubmit() {
    try {
      ...
      if (res?.status === 200) {
        toast.success('signup succesfully', { theme: "dark" });
        ...
        <div className="flex h-screen">
          ...
          <div className="w-full bg-gray-900 lg:w-1/2 flex items-center justify-center">
            <div className="max-w-md w-full p-6">
              ...
              <h1 className="text-sm font-semibold mb-6 text-gray-200 text-center">
                Join with Startup Gear with all time access{" "}
              </h1>
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div className="flex justify-center">
                  <button
                    type="submit"
                    className="w-[200px] bg-blue-600 text-white p-2 rounded-md hover:bg-gray-700 focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300"
                  >
                    Sign Up
                  </button>
                </div>
